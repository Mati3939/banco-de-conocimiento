registerModule({id:'cinematica',title:'Aplicaciones: posición, velocidad y aceleración',
  ...
  build(sec){
    ...
    c1.append(el('p',{class:'fuente'},'Fuente: apunte Semana 2 (posición, velocidad y aceleración como funciones vectoriales), Cálculo Multivariable — Canvas 2026-2.'));
    sec.append(c1);
    ...
    c2.append(el('p',{class:'fuente'},'Fuente: apunte Semana 2 (componentes tangencial y normal de la aceleración), Cálculo Multivariable — Canvas 2026-2.'));
    sec.append(c2);
    ...
    c3.append(el('p',{class:'fuente'},'Fuente: apunte Semana 2 (aceleración centrípeta, movimiento circular uniforme), Cálculo Multivariable — Canvas 2026-2.'));
    sec.append(c3);
    ...
    c4.append(el('p',{class:'fuente'},'Fuente: curva de la Pauta Control 1 CMUL 2026-1 (pregunta 2), extendida acá con las fórmulas de descomposición tangencial-normal del apunte Semana 2, Canvas 2026-2.'));
    sec.append(c4);
    ...
    const ej=el('details',{},
      ...
      el('div',{},
        ...
        el('p',{},'A diferencia de la hélice de la card anterior, acá $a_T\\ne0$: la partícula va acelerando en rapidez (no solo cambiando de dirección).')));
    c5.append(ej);

    c5.append(el('p',{class:'fuente'},'Fuente: ítem 18, Listado 1 (aplicación de velocidad/posición, ya resuelto en el tema anterior); curva de la Guía de Ayudantía 1, "Ejercicios propuestos" #2, extendida con las fórmulas de a_T/a_N del apunte Semana 2, Canvas 2026-2.'));
    sec.append(c5);
  }});
