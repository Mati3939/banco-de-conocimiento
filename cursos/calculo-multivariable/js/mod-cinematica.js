registerModule({id:'cinematica',title:'Aplicaciones: posición, velocidad y aceleración',
  ...
  build(sec){
    ...
    c1.append(el('p',{class:'fuente'},'Fuente: "Aplicaciones: Posición, Velocidad y Aceleración, Aceleración centrípeta y tangencial", contenido de la Semana 2 según la calendarización oficial (posición, velocidad y aceleración como funciones vectoriales son desarrollo estándar de Stewart/Larson), Cálculo Multivariable — Canvas 2026-2.'));
    sec.append(c1);
    ...
    c2.append(el('p',{class:'fuente'},'Fuente: desarrollo estándar de Stewart/Larson (componentes tangencial y normal de la aceleración) sobre "Aplicaciones: Posición, Velocidad y Aceleración, Aceleración centrípeta y tangencial", contenido de la Semana 2 según la calendarización oficial, Cálculo Multivariable — Canvas 2026-2.'));
    sec.append(c2);
    ...
    c3.append(el('p',{class:'fuente'},'Fuente: desarrollo estándar de Stewart/Larson (aceleración centrípeta, movimiento circular uniforme) sobre "Aceleración centrípeta y tangencial", contenido de la Semana 2 según la calendarización oficial, Cálculo Multivariable — Canvas 2026-2.'));
    sec.append(c3);
    ...
    c5.append(el('p',{class:'fuente'},'Fuente: ítem 18, Listado 1 (aplicación de velocidad/posición, ya resuelto en el tema "Funciones vectoriales"); curva de la Guía de Ayudantía 1, "Ejercicios propuestos" #2, extendida con las fórmulas de a_T/a_N de "Aplicaciones: Posición, Velocidad y Aceleración, Aceleración centrípeta y tangencial", contenido de la Semana 2 según la calendarización oficial, Canvas 2026-2.'));
    sec.append(c5);
  }});
