registerModule({id:'funciones-vectoriales',title:'Funciones vectoriales: dominio, derivada y recta tangente',
  ...
  build(sec){
    ...
    actualizarTraza();
    c1.append(el('p',{class:'fuente'},'Fuente: apunte Semana 1 (funciones vectoriales, definición y curva); curva del ítem 20, Listado 1, Canvas 2026-2.'));
    sec.append(c1);
    ...
    c2.append(el('p',{class:'fuente'},'Fuente: apunte Semana 1 (dominio de una función vectorial); ítem 13, Listado 1, Canvas 2026-2.'));
    sec.append(c2);
    ...
    c3.append(el('p',{class:'fuente'},'Fuente: apunte Semana 1 (derivada de una función vectorial e interpretación geométrica), Canvas 2026-2.'));
    sec.append(c3);
    ...
    c4.append(el('p',{class:'fuente'},'Fuente: apunte Semana 1 (reglas de derivación de productos punto y cruz); ítem 19, Listado 1, Canvas 2026-2.'));
    sec.append(c4);
    ...
    c5.append(el('p',{class:'fuente'},'Fuente: apunte Semana 1 (recta tangente a una curva paramétrica); ítems 14, 15 y 17, Listado 1, Canvas 2026-2.'));
    sec.append(c5);
